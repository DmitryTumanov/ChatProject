...
namespace _2Lab
{
    public class TripleDoubleKeyDes : BaseDes, ICipher
    {
        ...
        public string Encryption(string text)
        {
            ...
            var key2 = Key?.Substring(Key.Length * 1 / 3, Key.Length * 2 / 3);
            var it1 = Encript(text, key1);
            it1 = Encript(it1, key2);
            it1 = Encript(it1, key1);
            return it1;
        }
